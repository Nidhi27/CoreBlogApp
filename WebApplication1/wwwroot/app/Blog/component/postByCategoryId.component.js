...
var PostByCategoryId = (function () {
    function PostByCategoryId(route, router, postService, catService, tagService) {
        this.route = route;
        this.router = router;
...
exports.PostByCategoryId = PostByCategoryId;
//# sourceMappingURL=postByCategoryId.component.js.map